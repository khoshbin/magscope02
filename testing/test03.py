...
def connect_to_camera(camera_type="de_auto"):
    ...
    try:
        if camera_type == "de_auto":
            # Try DE cameras in priority order (exact classes from codebase)
            de_camera_priority = [
                # Modern DE API cameras (de.py) - newer DEAPI v2
                ('pyscope.de', 'DEApollo', 'Apollo - High-end model'),
                ('pyscope.de', 'DE20', 'DE20 - Standard model'),
                ...
                # Legacy DE API cameras (de1.py) - older DECameraClientLib
                ('pyscope.de1', 'DE20', 'DE20 Legacy Integration'),
                ('pyscope.de1', 'DE20c', 'DE20 Legacy Counting'),
                ('pyscope.de1', 'DE64', 'DE64 Legacy Integration'),
                ('pyscope.de1', 'DE64c', 'DE64 Legacy Counting'),  # This is the DE64c you asked about
                ('pyscope.de1', 'DE12', 'DE12 Legacy'),
                ('pyscope.de1', 'DE12Survey', 'DE12 Survey mode'),
                ('pyscope.de1', 'DE20Survey', 'DE20 Survey mode'),
                ('pyscope.de1', 'DD', 'DD Generic DE camera'),
